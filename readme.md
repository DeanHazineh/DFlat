...
- (v3) Datasets and pre-trained models are now downloaded when called instead of during install. Models are now initialized by their name instead of by paths to config files.
