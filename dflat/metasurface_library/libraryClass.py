...
class Nanofins_U350nm_H600nm:
    ...
    def plotLibrary(self, savepath=None):
        ...
        ax[0].imshow(self.transmission[0, :, :, wl_idx], vmin=0, vmax=1)
        ax[1].imshow(self.transmission[1, :, :, wl_idx], vmin=0, vmax=1)
        ax[4].imshow(self.phase[0, :, :, wl_idx], vmin=0, vmax=2 * np.pi, cmap="hsv")
        ax[5].imshow(self.phase[1, :, :, wl_idx], vmin=0, vmax=2 * np.pi, cmap="hsv")

        yidx = 24
        ax[2].imshow(self.transmission[0, 24, :, :].T, vmin=0, vmax=1)
        ax[3].imshow(self.transmission[1, 24, :, :].T, vmin=0, vmax=1)
