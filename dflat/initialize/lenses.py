...
def focusing_lens(
    ...
    Args:
        ...
        wavelength_set_m (list): List of wavelengths for incident light to be focused by each lens profile.
        depth_set_m (list): List of frontoplanar depths for point sources to be focused by each lens profile.
